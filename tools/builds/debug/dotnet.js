...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 679648,
    DYNAMIC_BASE = 5922528,
    DYNAMICTOP_PTR = 679488;
...
var ASM_CONSTS = {
  52666: function($0, $1, $2) {MONO.mono_wasm_add_typed_value ('pointer', $0, { ptr_addr: $1, klass_addr: $2 });},  
 52759: function($0, $1, $2) {MONO.mono_wasm_add_typed_value ('array', $0, { objectId: $1, length: $2 });},  
 545896: function() {return STACK_MAX;},  
 545918: function() {return TOTAL_STACK;},  
 627250: function($0, $1) {MONO.string_decoder.decode($0, $0 + $1, true);},  
 627534: function($0, $1, $2) {var str = MONO.string_decoder.decode ($0, $0 + $1); try { var res = eval (str); if (res === null || res == undefined) return 0; res = res.toString (); setValue ($2, 0, "i32"); } catch (e) { res = e.toString (); setValue ($2, 1, "i32"); if (res === null || res === undefined) res = "unknown exception"; } var buff = Module._malloc((res.length + 1) * 2); stringToUTF16 (res, buff, (res.length + 1) * 2); return buff;},  
 627953: function() {var err = new Error(); console.log ("Stacktrace: \n"); console.log (err.stack);}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 679552, 4), 679552);function _gmtime_r(time, tmPtr) {
